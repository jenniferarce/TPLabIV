...
if(isset($_SESSION['registrado'])){?>
    <div id="formInvitado" class="container">
      <form class="form-ingreso" onsubmit="ModificarInvitado();return false" style="background-color:transparent;" method="post">
        <h2 class="form-ingreso-heading">Datos del invitado</h2>
        <!-- REVISAR-->
        <input type="number" id="dni" name="dni" class="form-control" placeholder="DNI" title="Ingrese DNI sin puntos." min="1000000" max="99999999" required readonly><br>
        ...
        <button  class="btn btn-lg btn-success btn-block" type="submit"><span class="glyphicon glyphicon-floppy-save">&nbsp;&nbsp;</span>Guardar cambios</button>
        <!--<button  class="btn btn-lg btn-danger btn-block" onclick="Mostrar('mostrarInvitados')">Cancelar</button> -->
      </form>
